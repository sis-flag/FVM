...
\title{An edge-centered finite volume scheme of the heterogeneous and
anisotropic diffusion problems on polygonal meshes\tnoteref{tnote1}}%
\tnotetext[tnote1]{This is an example for title footnote coding.}

\author[1]{Ziqi \snm{Liu}}
\cortext[cor1]{Corresponding author.}
\ead{liuziqi18@gscaep.ac.cn}
  %Tel.: +0-000-000-0000;
 % fax: +0-000-000-0000;}
\author[2]{Shuai \snm{Miao}\corref{cor1}}
