...
%% plot error
NPS_L2 = [0.29, 7.61e-2, 1.92e-2, 4.82e-3, 1.20e-3, 3.01e-4];
NPS_Linf = [0.21, 7.03e-2, 1.88e-2, 4.79e-3, 1.20e-3, 3.01e-4];
...
plot([1e2, 3e4], 3.5e1*[1e2, 3e4].^(-1), 'k--')
xlabel("nkw")
ylabel("error")
xlim([1e1, 1e5])
ylim([1e-4, 1e0])
