...
%     if k == 3
%         figure
%         pcolor_func_unit(Mesh, u)
%         axis equal
%         xlim([0, 1])
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs0u.eps','-depsc','-loose')
%         
%         figure
%         pcolor_func_unit(Mesh, u - u_exact)
%         axis equal
%         xlim([0, 1])
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs0err.eps','-depsc','-loose')
%     end
end
...
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs1u.eps','-depsc','-loose')
%         
%         figure
...
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs1err.eps','-depsc','-loose')
%     end
end
...
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs2u.eps','-depsc','-loose')
%         
%         figure
%         pcolor_func_edge(Mesh, u - u_exact)
%         axis equal
...
%         ylim([0, 1])
%         set(gcf, 'Position', [200, 200, 400, 330])
%         print('pics/hs2err.eps','-depsc','-loose')
%     end
end
...
plot([1e2, 3e4], 3.5e2*[1e2, 3e4].^(-1), 'k--')
xlabel("nkw")
ylabel("error")
xlim([3e1, 3e5])
ylim([1e-4, 1e3])
